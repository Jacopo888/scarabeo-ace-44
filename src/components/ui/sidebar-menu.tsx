...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    <div ref={ref} data-sidebar="menu-skeleton" className={cn("rounded-md h-8 flex gap-2 px-2 items-center", className)} {...props}>
      ...
      <div className="h-4 flex-1 max-w-[--skeleton-width] bg-sidebar-border/50 rounded" data-sidebar="menu-skeleton-text" style={{ ["--skeleton-width" as any]: width } as React.CSSProperties} />
    </div>
  )
})
